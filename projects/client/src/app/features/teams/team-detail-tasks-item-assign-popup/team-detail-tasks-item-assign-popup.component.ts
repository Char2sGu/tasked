...
@Component({
  selector: 'app-team-detail-tasks-item-assign-popup',
  templateUrl: './team-detail-tasks-item-assign-popup.component.html',
  styleUrls: ['./team-detail-tasks-item-assign-popup.component.scss'],
})
export class TeamDetailTasksItemAssignPopupComponent
