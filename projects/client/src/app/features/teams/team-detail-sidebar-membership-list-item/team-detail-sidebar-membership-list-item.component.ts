...
@Component({
  selector: 'app-team-detail-sidebar-membership-list-item',
  templateUrl: './team-detail-sidebar-membership-list-item.component.html',
  styleUrls: ['./team-detail-sidebar-membership-list-item.component.scss'],
})
