...
@Component({
  selector: 'app-team-detail-settings',
  templateUrl: './team-detail-settings.component.html',
  styleUrls: ['./team-detail-settings.component.scss'],
})
export class TeamDetailSettingsComponent implements OnInit {
