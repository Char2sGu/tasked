...
@Component({
  selector: 'app-team-detail-assignments-item',
  templateUrl: './team-detail-assignments-item.component.html',
  styleUrls: ['./team-detail-assignments-item.component.scss'],
})
export class TeamDetailAssignmentsItemComponent implements OnInit {
