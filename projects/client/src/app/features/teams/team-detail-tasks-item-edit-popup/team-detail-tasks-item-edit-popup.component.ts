...
@Component({
  selector: 'app-team-detail-tasks-item-edit-popup',
  templateUrl: './team-detail-tasks-item-edit-popup.component.html',
  styleUrls: ['./team-detail-tasks-item-edit-popup.component.scss'],
})
export class TeamDetailTasksItemEditPopupComponent
